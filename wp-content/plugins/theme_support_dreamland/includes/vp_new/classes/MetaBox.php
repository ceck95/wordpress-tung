...

{
...

	{
		...
		if( ($pagenow == 'themes.php' && dreamland_set( $_GET, 'page' ) == BUNCH_NAME.'_option') || dreamland_set( $_REQUEST, 'action' ) == 'vp_ajax_wp_genuine_theme_options_save' )
...

	{
		...
		$meta = (array)dreamland_set( dreamland_set( $theme_options, $this->id ), $this->id );
		...
		$this->meta = dreamland_set( $theme_options, $this->id );
