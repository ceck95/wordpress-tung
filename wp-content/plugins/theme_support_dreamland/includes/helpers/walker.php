...
class MegaMenuWalkerEdit extends Walker_Nav_Menu  {
	...
	function start_el(&$output, $object, $depth = 0, $args = array(), $current_object_id = 0)  {
		...
		$item_id = esc_attr( dreamland_set($item, 'ID' ) );
		...
		if ( 'taxonomy' == dreamland_set($item, 'type') ) {
		...
		} elseif ( 'post_type' == dreamland_set($item, 'type') ) {
		...
		$classes = array(
			...
			'menu-item-' . esc_attr( dreamland_set( $item, 'object' ) ),
		...
		$title = dreamland_set($item, 'title');
