...
class Bunch_Functions {
...

	{
		...
		if( dreamland_set( $options, '_enable_wp_login' ) ) {


			


			$this->wp_login_logo = dreamland_set( $options, '_wp_login_logo', get_stylesheet_directory_uri().'/images/mlogo.png' );


			$this->wp_login_bg = dreamland_set( $options, '_wp_login_bg', get_stylesheet_directory_uri().'/images/mbg_01.png' );


			$this->wp_login_name = dreamland_set( $options, '_wp_login_page_title', get_bloginfo( 'name' ) );
	...
	*/
...

	{
		...
		if( dreamland_set( $options, 'maintainance_status' ) ) {


			$m_page = dreamland_set( $options, 'maintainance_page' );
