<?php
return array(
    'title' => __( 'Dreamland Theme Options', BUNCH_NAME ),
    'logo' => get_template_directory_uri() . '/images/logo-4.png',
    'menus' => array(
        // General Settings
         array(
				...
				array(
                    ...
                    'controls' => array(
						...
						array(
                            'type' => 'toggle',
                            'name' => 'switcher',
                            'label' => __( 'Color Switcher', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Color Switcher', BUNCH_NAME)
						...
						array(
                            'type' => 'toggle',
                            'name' => 'show_vc_footer',
                            'label' => __( 'Show/Hide footer for blog pages', BUNCH_NAME ),
							'default' => 0,
							'description' => __('Show/Hide footer for blog pages', BUNCH_NAME)
                ...
                array(
                    ...
                    'controls' => array(
						...
						array(
                            'type' => 'toggle',
                            'name' => 'topbar',
                            'label' => __( 'Show/Hide TopBar', BUNCH_NAME ),
							'default' => 1,
							'description' => __('Show/Hide TopBar', BUNCH_NAME)
						...
						array(
							...
							'fields' => array(
								...
								array(
									'type' => 'textbox',
									'name' => 'topbar_email',
									'label' => __( 'Topbar Email', BUNCH_NAME ),
									'description' => __( 'Enter topbar Email', BUNCH_NAME ),
						...
						array(
							'type' => 'section',
							'title' => __('Onepage Settings', BUNCH_NAME),
							'name' => 'onepage_settings',
							'fields' => array(
								array(
									'type' => 'upload',
									'name' => 'onepage_logo_image',
									'label' => __('Onepage Logo Image', BUNCH_NAME),
									'description' => __('Inser the logo image', BUNCH_NAME),
									'default' => get_template_directory_uri().'/images/logo-1.png'
								),
								array(
									'type' => 'textarea',
									'name' => 'onepage_address',
								...
								array(
									'type' => 'textbox',
									'name' => 'onepage_phone',
									'label' => __( 'Onepage Phone', BUNCH_NAME ),
									'description' => __( 'Enter the phone Number', BUNCH_NAME ),
									'default' => ' +49 123 456 789' 
								),
								array(
									'type' => 'textbox',
									'name' => 'onepage_email',
									'label' => __( 'Onepage Email', BUNCH_NAME ),
									'description' => __( 'Enter topbar Email', BUNCH_NAME ),
									'default' => 'support@email.com' 
								),
								array(
									'type' => 'select',
									'name' => 'onepage_contact_page',
									'label' => __('Contact page', BUNCH_NAME),
									'description' => __('choose the contact page', BUNCH_NAME),
									'items' => array(
										'data' => array(
											array(
												'source' => 'function',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
							...
							'description' => __( 'Enter the Copy Right Text', BUNCH_NAME ),
							'default' => 'Copryright 2015 by Dreamland | All rights reserved'
						),
