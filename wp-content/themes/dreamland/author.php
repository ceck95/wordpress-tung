...
if(dreamland_set($settings, 'author_blog_style')=='blog_style2' || dreamland_set($_GET, 'blog_style') == 'blog_style2' ) $style2 = 'blog_style2';
if(dreamland_set($_GET, 'layout_style')) $layout = dreamland_set($_GET, 'layout_style'); else
$layout = dreamland_set( $settings, 'author_page_layout', 'right' );
$sidebar = dreamland_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
...
$title = dreamland_set($options, 'author_title');
$bg = dreamland_set($options, 'author_bg');
?>
<!--Page Title-->
