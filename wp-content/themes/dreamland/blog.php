    ...
    <article class="inner-box">
        ...
        <figure class="image-box">
            <a href="<?php echo esc_url(get_permalink(get_the_id()));?>">
            	<?php the_post_thumbnail('dreamland_size_6', array('class' => 'img-responsive'));?>
            </a>
        ...
        <div class="lower-part">
            <div class="post-info">
               <?php esc_html_e('Posted On', 'dreamland')?><a class="extraspace" href="<?php echo esc_url(get_month_link(get_the_date('Y'), get_the_date('m'))); ?>"><strong><?php echo get_the_date('M d, Y');?></strong></a>
            </div>
