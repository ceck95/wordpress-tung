<?php 
	...
	if($homeland_portfolio_tax_layout == "Right Sidebar") :
		...
		$homeland_portfolio_inside_class = "property-list property-four-cols property-grid-sidebar clearfix";
		$homeland_portfolio_tax_template = "portfolio-sidebar";
		$homeland_portfolio_tax_class = "property-cols masonry-item ";
	elseif($homeland_portfolio_tax_layout == "Left Sidebar") :
		...
		$homeland_portfolio_tax_class = "portfolio-cols masonry-item ";
	endif;
	...
	<section class="theme-pages">
		<div class="inside clearfix">
			<div class="<?php echo esc_attr( $homeland_portfolio_main_class ); ?>">
							...
							<ul class="clearfix">
								<?php
									for($homeland_i = 1; $wp_query->have_posts(); $homeland_i++) {
										$wp_query->the_post();			
										$homeland_columns = 3;	
										$homeland_class = $homeland_portfolio_tax_class;
										$homeland_class .= ($homeland_i % $homeland_columns == 0) ? 'last' : '';

										get_template_part( 'loop', $homeland_portfolio_tax_template );
									}
								?>
							</ul>
						</div>
				...
				<?php 
					if($homeland_page_nav =="Next Previous Link") : homeland_next_previous(); 
			...
			<?php if($homeland_portfolio_tax_layout == "Right Sidebar" || $homeland_portfolio_tax_layout == "Left Sidebar") : ?>
				<div class="<?php echo esc_attr( $homeland_portfolio_sidebar_class ); ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
