...
<div class="comments" id="comments">
	<?php if ( have_comments() ) : ?>
		...
		<ul class="comment-list">
	 		<?php 
	 			$args = array ('type' => 'all', 'callback' => 'homeland_theme_comment');
	...
	<?php 
		...
		$args = array(
			...
			'comment_notes_after' => '<p class="form-allowed-tags">' .
				sprintf(
					esc_html__( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s','homeland' ),
