 ...
 */
require_once get_template_directory() . '/includes/lib/tgm/class-tgm-plugin-activation.php';
...
function homeland_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'http://themecss.com/wp/plugins/homeland/codeex-shortcodes.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://themecss.com/wp/plugins/homeland/codeex-post-types.zip', 
            'required'           => true, 
            'version'            => '1.0.0', 
        ...
        array(
            'name'               => esc_html__('Aqua Page Builder', 'homeland'), 
            'slug'               => 'aqua-page-builder', 
            'source'             => 'http://themecss.com/wp/plugins/homeland/aqua-page-builder.zip', 
            'required'           => false, 
            'version'            => '1.1.5', 
            'force_activation'   => false, 
            'force_deactivation' => false, 
        ...
        array(
            ...
            'slug'               => 'revslider', 
            'source'             => 'http://themecss.com/wp/plugins/homeland/revslider.zip', 
            'required'           => false, 
            'version'            => '5.3.1.5', 
            'force_activation'   => false, 
            'force_deactivation' => false, 
        ...
        array(
            'name'      => esc_html__('dsIDXpress', 'homeland'),
            'slug'      => 'dsidxpress',
            'required'  => false,
        ),
        ...
        array(
            'name'      => esc_html__('Simple Custom CSS', 'homeland'),
