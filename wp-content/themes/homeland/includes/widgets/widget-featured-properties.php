	...
	class homeland_Widget_Featured_Properties extends WP_Widget {
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				<p>
					<label for="<?php echo $this->get_field_id($property_limit); ?>">
						<?php esc_html_e('Number of Posts', 'homeland'); ?>
					</label>
					<input class="widefat" type="text" id="<?php echo $this->get_field_id($property_limit); ?>" name="<?php echo $this->get_field_name($property_limit); ?>" value="<?php echo esc_html( $instance_property_limit ); ?>">
				</p>	
		<?php
				}			
		}
