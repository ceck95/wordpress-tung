		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;					
				...
				?>
					...
					<p>
						<small>
							<i><?php esc_html_e( 'Top Agents List will display automatically base on the number of properties they listed...', 'homeland' ); ?></i>
						</small>
					</p><?php
				}			
		}
