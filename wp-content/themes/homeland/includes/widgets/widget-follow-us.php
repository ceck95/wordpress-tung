					...
					<ul class="clearfix">
						<?php 
							if(!empty( $homeland_twitter )) : ?>	
								<li class="twitter"><a href="http://twitter.com/<?php echo esc_html( $homeland_twitter ); ?>" target="_blank"><i class="fa fa-twitter"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_facebook )) : ?>	
								<li class="facebook"><a href="http://facebook.com/<?php echo esc_html( $homeland_facebook ); ?>" target="_blank"><i class="fa fa-facebook"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_youtube )) : ?>	
								<li class="youtube"><a href="<?php echo esc_url( $homeland_youtube ); ?>" target="_blank"><i class="fa fa-youtube"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_linkedin )) : ?>	
								<li class="linkedin"><a href="<?php echo esc_url( $homeland_linkedin ); ?>" target="_blank"><i class="fa fa-linkedin"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_pinterest )) : ?>	
								<li class="pinterest"><a href="http://pinterest.com/<?php echo esc_html( $homeland_pinterest ); ?>" target="_blank"><i class="fa fa-pinterest"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_dribbble )) : ?>	
								<li class="dribbble"><a href="http://dribbble.com/<?php echo esc_html( $homeland_dribbble ); ?>" target="_blank"><i class="fa fa-dribbble"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_gplus )) : ?>	
								<li class="gplus"><a href="<?php echo esc_url( $homeland_gplus ); ?>" target="_blank"><i class="fa fa-google-plus"></i></a></li><?php 
							endif;
							if(!empty( $homeland_instagram )) : ?>	
								<li class="instagram"><a href="http://instagram.com/<?php echo esc_html( $homeland_instagram ); ?>" target="_blank"><i class="fa fa-instagram"></i></a></li><?php 
							endif; 
							if(!empty( $homeland_rss )) : ?>	
								<li class="rss"><a href="<?php echo esc_url( $homeland_rss ); ?>" target="_blank"><i class="fa fa-rss"></i></a></li><?php 
							endif;  
						?>	
					</ul>
				</div>
