<?php
	...
	class homeland_Widget_Flickr extends WP_Widget {
		...
		function homeland_Widget_Flickr() {		
			$widget_ops = array(
				'classname' => 'homeland_widget-flickr', 
				'description' => esc_html__('Custom widget for flickr feed', 'homeland')
			);	
			parent::__construct('Flickr', esc_html__('Homeland - Flickr Feed', 'homeland'), $widget_ops);		
		}
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;
				...
				<p>
					<label for="<?php echo $this->get_field_id($homeland_flickr_id); ?>">
						<?php esc_html_e('ID', 'homeland'); ?>
					</label>
					<input class="widefat" type="text" id="<?php echo $this->get_field_id($homeland_flickr_id); ?>" name="<?php echo $this->get_field_name($homeland_flickr_id); ?>" value="<?php echo esc_html( $instance_homeland_flickr_id ); ?>">		
				</p>
				<p>
					<label for="<?php echo $this->get_field_id($homeland_flickr_limit); ?>">
						<?php esc_html_e('Number of Images', 'homeland'); ?>
					</label>
					<input class="widefat" type="text" id="<?php echo $this->get_field_id($homeland_flickr_limit); ?>" name="<?php echo $this->get_field_name($homeland_flickr_limit); ?>" value="<?php echo esc_html( $instance_homeland_flickr_limit ); ?>">
				</p>	
		<?php
				}			
		}
