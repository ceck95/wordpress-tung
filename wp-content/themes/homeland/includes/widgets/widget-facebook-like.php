	...
	class homeland_Widget_Facebook_Like extends WP_Widget {
		...
		function widget($args, $instance) {		
			...
			if (empty($title)) $title = false;					
				...
				?>
					<p>
						<label for="<?php echo $this->get_field_id($homeland_page_url); ?>">
							<?php esc_html_e('Facebook Page URL', 'homeland'); ?>
						</label>
						<input class="widefat" type="text" id="<?php echo $this->get_field_id($homeland_page_url); ?>" name="<?php echo $this->get_field_name($homeland_page_url); ?>" value="<?php echo esc_url( $instance_homeland_page_url ); ?>">		
					</p>	
		<?php
				}			
		}
