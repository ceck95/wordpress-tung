			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'description' => esc_html__('Upload archive background image for archive page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_background_image_section',
						'description' => esc_html__('Upload taxonomy background image for taxonomy page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_background_image_section',
						'description' => esc_html__('Upload agent background image for agent single page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_background_image_section',
						'description' => esc_html__('Upload search background image for search page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_background_image_section',
						'description' => esc_html__('Upload attachment background image for attachment page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_background_image_section',
						'description' => esc_html__('Upload 404 not found background image for 404 page', 'homeland')
					)
				)
			);
?>