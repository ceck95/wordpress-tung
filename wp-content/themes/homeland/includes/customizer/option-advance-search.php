	  ...
	  // Main Section
		$wp_customize->add_section('homeland_search_main_section', array(
			...
			$wp_customize->add_control('homeland_search_header', array(
			 	'label' => esc_html__('Search Header Title', 'homeland'),
			 	'section' => 'homeland_search_main_section',
			 	'type' => 'text',
			));
			...
			$wp_customize->add_control('homeland_search_subtitle', array(
			 	'label' => esc_html__('Search Subtitle', 'homeland'),
			 	'section' => 'homeland_search_main_section',
			 	'type' => 'text',
			));
			...
			$wp_customize->add_control( 'homeland_advance_search_layout', array(
				'label' => esc_html__( 'Select your Advance Search Layout', 'homeland' ),
				'type' => 'select',
				'section' => 'homeland_search_main_section',
				'choices' => array(
			...
			$wp_customize->add_control('homeland_search_property_limit', array(
			 	'label' => esc_html__('Number of search properties per page', 'homeland'),
			 	'description' => esc_html__('This will work on search page only.', 'homeland'),
			 	'section' => 'homeland_search_main_section',
			 	'type' => 'text',
			));
