	...
	$wp_customize->add_panel( 'homeland_header_panel', array(
	  ...
	  // Main Section
		$wp_customize->add_section('homeland_header_main_section', array(
			...
			// Hide call us
			$wp_customize->add_setting( 'homeland_hide_call_us', array(
				'type' => 'option',
				'default' => '',
				'sanitize_callback' => 'homeland_option_yes_no',
			) );
			$wp_customize->add_control( 'homeland_hide_call_us', array(
				'label' => esc_html__( 'Hide Call us label', 'homeland' ),
				'type' => 'radio',
				'section' => 'homeland_header_main_section',
				'choices' => array(
					'true' => esc_html__( 'Yes', 'homeland' ),
		...
		$wp_customize->add_section('homeland_header_button_section', array(
			'title' => esc_html__('Buttons', 'homeland'),
			'panel' => 'homeland_header_panel',
		));
			...
			$wp_customize->add_control('homeland_login_link', array(
			 	'label' => esc_html__('Custom Login Link', 'homeland'),
			 	'section' => 'homeland_header_button_section',
			...
			$wp_customize->add_control('homeland_register_link', array(
			 	'label' => esc_html__('Custom Register Link', 'homeland'),
			 	'section' => 'homeland_header_button_section',
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_header_image_section',
						'description' => esc_html__('Upload archive header image for archive page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_header_image_section',
						'description' => esc_html__('Upload taxonomy header image for taxonomy page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_header_image_section',
						'description' => esc_html__('Upload search header image for search page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_header_image_section',
						'description' => esc_html__('Upload attachment header image for attachment page', 'homeland')
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Image_Control(
					...
					array(
						...
						'section' => 'homeland_header_image_section',
						'description' => esc_html__('Upload 404 not found header image for 404 page', 'homeland')
					)
				)
			);
?>