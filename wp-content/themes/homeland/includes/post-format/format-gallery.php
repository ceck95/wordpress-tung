					...
					if ( $homeland_attachments ) :								
						foreach ( $homeland_attachments as $homeland_attachment ) :
							...
							switch ( $homeland_type ) {
								case 'video/mp4': ?>
									<li>
										<video id="videojs_gallery" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="none" width="<?php echo esc_html( $homeland_blog_video_class_width ); ?>" height="<?php echo esc_html( $homeland_blog_video_class_height ); ?>" poster="<?php echo get_template_directory_uri(); ?>/img/video-attachment.jpg" data-setup="{}">
											<source src="<?php echo esc_url( $homeland_attachment_url ); ?>" type='video/mp4' />
											<source src="<?php echo esc_url( $homeland_attachment_url ); ?>" type='video/webm' />
											<source src="<?php echo esc_url( $homeland_attachment_url ); ?>" type='video/ogg' />
										</video>
									</li><?php
								break;
								default: 
