						...
						if (have_posts()) : 
							if ( post_password_required() ) :
								...
								while (have_posts()) : the_post(); 
									...
									$homeland_property_amenities = get_the_term_list($post->ID, 'homeland_property_amenities', '<ul class="clearfix"><li>', '</li><li>', '</li></ul>');
									...
									$args = array( 
										...
										'post_status' => null, 
										'post_parent' => $post->ID, 
										'exclude' => $homeland_thumb_id_value
									);
								...
								?>
									<article id="post-<?php the_ID(); ?>" class="plist">
										...
										<div class="property-info-agent clearfix">
											<?php
												...
												if(!empty($homeland_bathroom)) : ?>
													<span><i class="fa fa-bath"></i><strong><?php esc_html_e( 'Bathrooms', 'homeland' ); echo ":"; ?></strong>
								...
								if(empty($homeland_other_properties)) : ?>
									<div class="property-list clearfix">
										...
										<div class="property-four-cols clearfix">
											<?php
