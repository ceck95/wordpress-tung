						      ...
						      ?>
						    	<div class="agent-list clearfix">
						    		...
						    		<div class="agent-desc">
						    			<h4>
						    				<a href="<?php echo esc_url( get_author_posts_url( $homeland_agent_id ) ); ?>"><?php echo esc_html( $homeland_agent_name ); ?></a>
						    			</h4>
						    				...
						    				<?php
						    					if(!empty($homeland_agent_telno)) : ?>
						    						<span>
						    							...
						    							<strong><?php esc_html_e( 'Tel no', 'homeland' ); echo ":"; ?></strong>
						    							<?php echo esc_html( $homeland_agent_telno ); ?>
						    						</span><?php
						    					endif;
						    					if(!empty($homeland_agent_mobile)) : ?>
						    						<span>
						    							<i class="fa fa-mobile"></i>
						    							<strong><?php esc_html_e( 'Mobile', 'homeland' ); echo ":"; ?></strong>
						    							<?php echo esc_html( $homeland_agent_mobile ); ?>
						    						</span><?php
						    					endif;
						    					if(!empty($homeland_agent_fax)) : ?>
						    						<span>
						    							<i class="fa fa-print"></i>
						    							<strong><?php esc_html_e( 'Fax', 'homeland' ); echo ":"; ?></strong> 
						    							<?php echo esc_html( $homeland_agent_fax ); ?>
						    						</span><?php
						    					endif;
			 			    				?>
						    			</label>
							    		<label class="listed">
							    			<i class="fa fa-home fa-lg"></i> <?php esc_html_e( 'Listed', 'homeland' ); echo ":"; ?>
							    			<span>
							    				<?php echo intval($homeland_count); echo "&nbsp;"; esc_html_e( 'Properties', 'homeland' ); ?>
							    			</span>
							    		</label>
