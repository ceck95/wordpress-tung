<?php 
	...
	$homeland_hide_blog_archive_advance_search = esc_attr( get_option('homeland_hide_blog_archive_advance_search') );
	...
	elseif($homeland_archive_layout == "2 Columns" || $homeland_archive_layout == "3 Columns" || $homeland_archive_layout == "4 Columns") :
		$homeland_archive_class_main = "theme-fullwidth";
		$homeland_archive_class_container = "blog-fullwidth masonry clearfix";
	elseif($homeland_archive_layout == "Grid") :
		$homeland_archive_class_main = "left-container";
		$homeland_archive_class_container = "blog-grid masonry clearfix";
	...
	if(empty($homeland_hide_blog_archive_advance_search)) : homeland_advance_search(); endif;
?>
	...
	<section class="theme-pages">
		<div class="inside clearfix">
			<div class="<?php echo esc_attr( $homeland_archive_class_main ); ?>">	
				<?php 
					if(!empty( $homeland_term_description )) : 
						echo esc_html( $homeland_term_description ); 
					endif; 
				?>
				<div class="<?php echo esc_attr( $homeland_archive_class_container ); ?>">
					<?php
						if ($wp_query->have_posts()) : 
							...
							esc_html_e( 'You have no blog post yet!', 'homeland' );
						endif;		
					?>
				</div>
				<?php
			...
			<?php if($homeland_archive_layout != "Timeline" && $homeland_archive_layout != "Fullwidth" && $homeland_archive_layout != "2 Columns" && $homeland_archive_layout != "3 Columns" && $homeland_archive_layout != "4 Columns") : ?>
				<div class="<?php echo esc_attr( $homeland_archive_class_sidebar ); ?>"><?php get_sidebar(); ?></div>
			<?php endif; ?>
		</div>
	</section>
